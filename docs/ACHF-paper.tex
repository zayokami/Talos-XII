...
\begin{itemize}[leftmargin=*]
\item Public source: \url{https://github.com/zayokami/Talos-XII}; source commit:
\texttt{4ee46aecd31ae5dde4869dbe78e08640fe487e8e}; every child manifest records
\texttt{source\_reproducible\_from\_commit=true}.
