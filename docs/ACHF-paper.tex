...
\item Raw artifact: \url{https://doi.org/10.5281/zenodo.21440312}
(Zenodo, CC-BY 4.0). The local verification directory
\texttt{target/release/bench\_output\_final} is not itself the public
artifact; the archive above is its immutable published copy.
