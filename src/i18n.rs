...
impl I18n {
    ...
    pub fn get(lang: Language, key: &str) -> String {
        match (lang, key) {
            ...
            (Language::En, "bench_list_ablation") => "ablation     — ACHF on/off ablation comparison".to_string(),
            (Language::Cn, "bench_list_ablation") => "ablation     — ACHF 开/关消融对比".to_string(),
            (Language::En, "bench_list_mode") => "mode         — lite vs full mode comparison".to_string(),
            (Language::Cn, "bench_list_mode") => "mode         — lite vs full 模式对比".to_string(),
            (Language::En, "bench_list_path") => "path         — Cached/LowRank/Dense inference path latency".to_string(),
            (Language::Cn, "bench_list_path") => "path         — Cached/LowRank/Dense 推理路径延迟".to_string(),
            ...
            (Language::En, "bench_usage_paper") => "  bench paper              Run all 7 experiments (default 3 trials)".to_string(),
            (Language::Cn, "bench_usage_paper") => "  bench paper              运行全部 7 项实验（默认 3 trials）".to_string(),
